<div class="container">
  <main>
    <div class="col-md-8 col-lg-8">
      ...
      <form action="<?php echo site_url('insertUSUARIOS') ?>" method="post" class="row g-3">
        ...
        <div class="col-md-12 col-lg-12">
          ...
          <div class="row g-3">
            <div class="col-sm-6">
              ...
              <input type="text" name="usuario" class="form-control" placeholder="Crie seu usuario" value="<?= set_value('usuario') ?>">
            </div>

            <div class="col-sm-6">
              <label for="validationDefault03" class="form-label">Senha</label>
              <input type="text" class="form-control" name="senha" placeholder="Crie sua senha" value="<?= set_value('senha') ?>">
            </div>
          </div>
