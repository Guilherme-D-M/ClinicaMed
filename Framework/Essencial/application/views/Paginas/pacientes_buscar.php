<div class="container center">
  <main>
    ...
    <h4 class="mb-3 text-center">Buscar - Pacientes</h4>
    <hr class="my-4">

    <div class="d-flex flex-wrap justify-content-center py-1 mb-2  text-gray">
      <form action="<?php echo site_url('buscarNomePACIENTES') ?>" method="post" class="row g-3">
        <div class="col-sm-12">
          <h5 class="mb-3">Nome - Pacientes</h5>
          <input type="text" class="form-control" id="nome" name="nome" placeholder="Pesquisar nome">
